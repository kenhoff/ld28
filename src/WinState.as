package
{
	...
	public class WinState extends FlxState 
	{
		...
		override public function create():void
		{
			...
			var text:FlxText = new FlxText((FlxG.width / 2) - (textWidth / 2), (FlxG.height / 2) - (textSize * 3), textWidth, "YOU WIN")
			text.size = textSize;
			...
			textSize = 16;
			textWidth = 300;
			var startText:FlxText = new FlxText((FlxG.width / 2) - (textWidth / 2), (FlxG.height / 2) + (textSize), textWidth, "Press SPACE to play again")
